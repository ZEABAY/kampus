...
public enum BusinessErrorCodes {
    ...
    EMAIL_ALREADY_EXISTS(409, CONFLICT, EXCEPTION_CONSTANT_EMAIL_ALREADY_EXISTS),
    PHONE_NUMBER_ALREADY_EXISTS(409, CONFLICT, EXCEPTION_CONSTANT_PHONE_NUMBER_ALREADY_EXISTS),
